...
describe('createDataFromAnnotatedType — empty mode', () => {
  ...
  it('should return undefined/null for those types', () => {
    expect(createDataFromAnnotatedType(defineAnnotatedType().designType('undefined').$type)).toBe(
      undefined
    )
  ...
  it('should build nested objects', () => {
    const address = defineAnnotatedType('object').prop('street', str()).prop('city', str()).$type
    const type = defineAnnotatedType('object').prop('name', str()).prop('address', address).$type
  ...
  it('should build tuple with defaults for each position', () => {
    const type = defineAnnotatedType('tuple').item(str()).item(num()).item(bool()).$type

    expect(createDataFromAnnotatedType(type)).toEqual(['', 0, false])
  })

  it('should use first branch for unions', () => {
    const type = defineAnnotatedType('union').item(str()).item(num()).$type
  ...
  it('should skip phantom types in objects', () => {
    ...
    const type = defineAnnotatedType('object').prop('name', str()).prop('_phantom', phantom).$type
  ...
  it('should skip optional nested object', () => {
    const address = defineAnnotatedType('object').prop('street', str()).optional().$type
    const type = defineAnnotatedType('object').prop('name', str()).prop('address', address).$type
...
describe('createDataFromAnnotatedType — default mode', () => {
  it('should use meta.default for string prop (raw string)', () => {
    const type = defineAnnotatedType('object')
      .prop(
        ...
        defineAnnotatedType()
          .designType('string')
          .annotate('meta.default' as any, 'John').$type
      )
      .prop('age', num()).$type
  ...
  it('should parse meta.default as JSON for number', () => {
    const type = defineAnnotatedType('object')
      ...
      .prop(
        ...
        defineAnnotatedType()
          .designType('number')
          .annotate('meta.default' as any, '25').$type
      ).$type
  ...
  it('should parse meta.default as JSON for boolean', () => {
    const prop = defineAnnotatedType()
      .designType('boolean')
      .annotate('meta.default' as any, 'true').$type
    ...
    const type = defineAnnotatedType('object')
      ...
      .prop(
        ...
        defineAnnotatedType()
          .designType('string')
          .optional()
          .annotate('meta.default' as any, 'buddy').$type
      ).$type
  ...
  it('should skip optional prop when no meta.default', () => {
    const type = defineAnnotatedType('object').prop('name', str()).prop('nickname', str(true)).$type
  ...
  it('should apply meta.default on an array type', () => {
    ...
    const type = defineAnnotatedType('object').prop('tags', arrType).$type
  ...
  it('should fall back to structural default when meta.default fails validation', () => {
    ...
    const prop = defineAnnotatedType()
      .designType('number')
      .annotate('meta.default' as any, '"hello"').$type
  ...
  it('should fall back when meta.default has invalid JSON for non-string type', () => {
    const prop = defineAnnotatedType()
      .designType('number')
      .annotate('meta.default' as any, 'not-json').$type
    expect(createDataFromAnnotatedType(prop, { mode: 'default' })).toBe(0)
  })
  ...
  it('should fall back when object meta.default has wrong shape', () => {
    ...
    const type = defineAnnotatedType('object').prop('address', address).$type
...
describe('createDataFromAnnotatedType — example mode', () => {
  it('should use meta.example for string prop', () => {
    const type = defineAnnotatedType('object')
      .prop(
        ...
        defineAnnotatedType()
          .designType('string')
          .annotate('meta.example' as any, 'Jane Doe').$type
      )
      .prop(
        'age',
        defineAnnotatedType()
          .designType('number')
          .annotate('meta.example' as any, '30').$type
      ).$type
    ...
    const type = defineAnnotatedType('object')
      ...
      .prop(
        ...
        defineAnnotatedType()
          .designType('string')
          .optional()
          .annotate('meta.example' as any, 'A developer').$type
      ).$type
  ...
  it('should not read meta.default in example mode', () => {
    const prop = defineAnnotatedType()
      .designType('string')
      .annotate('meta.default' as any, 'default-val').$type
  ...
  it('should generate one sample item for array of objects', () => {
    const item = defineAnnotatedType('object').prop('name', str()).prop('age', num()).$type
  ...
  it('should use meta.example on array items when available', () => {
    const itemType = defineAnnotatedType('object')
      .prop(
        ...
        defineAnnotatedType()
          .designType('string')
          .annotate('meta.example' as any, 'Jane').$type
      )
      .prop(
        'age',
        defineAnnotatedType()
          .designType('number')
          .annotate('meta.example' as any, '25').$type
      ).$type
...
describe('createDataFromAnnotatedType — callback mode', () => {
  it('should use callback return value', () => {
    const type = defineAnnotatedType('object').prop('name', str()).prop('age', num()).$type
...
describe('createDataFromAnnotatedType — union handling', () => {
  ...
  it('should use first branch when no annotation on union', () => {
    const union = defineAnnotatedType('union').item(num()).item(str()).$type
