...
$('object', MyInterface)
  ...
  .prop('age', $().designType('number').tags('number').annotate('label', 'Original Age').$type)
  .prop(
    'email',
    $()
      .designType('string')
  ...
  .prop(
    'address',
    $('object')
      .prop('street', $().designType('string').tags('string').annotate('label', 'Street').$type)
      .prop('city', $().designType('string').tags('string').$type).$type
  )
  .annotate('meta.description', 'Original')

$('object', AnnotatedInterface)
  .prop('name', $().designType('string').tags('string').annotate('label', 'Custom Name').$type)
  .prop('age', $().designType('number').tags('number').annotate('label', 'Custom Age').$type)
  .prop(
    'email',
    $()
      .designType('string')
  ...
  .prop(
    ...
    $('object')
      ...
      .prop(
        'city',
        $().designType('string').tags('string').annotate('label', 'Custom Address City').$type
      ).$type
  )
