...
$('', TPrimitive).designType('string').tags('string')

$('union', TPirmiitiveUn)
  .item($().designType('string').tags('string').$type)
  .item($().designType('number').tags('number').$type)

$('', TLiteral).designType('string').value('value')

$('', TNumber).designType('number').value(5)

$('tuple', TTuple1).item($().designType('string').tags('string').$type)

$('tuple', TTuple2)
  .item($().designType('string').tags('string').$type)
  .item($().designType('string').tags('string').$type)

$('array', TTupleArray).of(
  $('tuple')
    .item($().designType('string').tags('string').$type)
    .item($().designType('string').tags('string').$type).$type
)

$('array', TArray).of($().designType('string').tags('string').$type)

$('array', TArray2).of($('array').of($().designType('string').tags('string').$type).$type)

$('array', TArray3).of(
  $('array').of($('array').of($().designType('string').tags('string').$type).$type).$type
)

$('array', TComplexArray).of(
  $('union')
    .item($().designType('string').tags('string').$type)
    .item($().designType('number').tags('number').$type).$type
)

$('array', TComplexArray2).of(
  $('array').of(
    $('union')
      .item($().designType('string').tags('string').$type)
      .item($().designType('number').tags('number').$type).$type
...
$('union', TComplexArray4)
  .item($().designType('string').tags('string').$type)
  .item($('array').of($().designType('number').tags('number').$type).$type)
...
$('object', TObjectIntersection)
  ...
  .prop('b', $().designType('string').value('b').$type)
