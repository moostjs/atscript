...
export interface TMongoSchemaSyncHost {
  ...
  readonly _table: {
    ...
    readonly indexes: ReadonlyMap<string, { key: string; name: string; type: string; fields: ReadonlyArray<{ name: string; weight?: number }> }>
...
export function getDesiredTableOptionsImpl(cappedOptions?: { size: number; max?: number }): TExistingTableOption[] {
...
export async function getExistingTableOptionsImpl(host: TMongoSchemaSyncHost): Promise<TExistingTableOption[]> {
...
export async function dropViewByNameImpl(host: TMongoSchemaSyncHost, viewName: string): Promise<void> {
...
export async function dropTableByNameImpl(host: TMongoSchemaSyncHost, tableName: string): Promise<void> {
...
export async function syncColumnsImpl(host: TMongoSchemaSyncHost, diff: TColumnDiff): Promise<TSyncColumnResult> {
...
export async function dropColumnsImpl(host: TMongoSchemaSyncHost, columns: string[]): Promise<void> {
