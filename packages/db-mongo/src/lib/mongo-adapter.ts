...
import { searchImpl, searchWithCountImpl, vectorSearchImpl, vectorSearchWithCountImpl, getSearchIndexesImpl, isVectorSearchableImpl } from './mongo-search'
import type { TMongoSchemaSyncHost } from './mongo-schema-sync'
import { tableExistsImpl, ensureTableImpl, syncIndexesImpl, syncColumnsImpl, dropColumnsImpl, renameTableImpl, recreateTableImpl, dropTableImpl, dropViewByNameImpl, dropTableByNameImpl, getDesiredTableOptionsImpl, getExistingTableOptionsImpl, DESTRUCTIVE_OPTION_KEYS } from './mongo-schema-sync'
import { validateMongoIdPlugin } from './validate-plugins'

export type { TPlainIndex, TSearchIndex, TMongoIndex, TMongoSearchIndexDefinition } from './mongo-types'
...
export class MongoAdapter extends BaseDbAdapter {
  ...
  override async loadRelations(
    ...
    return loadRelationsImpl(this as any as TMongoRelationHost, rows, withRelations, relations, foreignKeys, tableResolver)
  }
  ...
  override getSearchIndexes(): TSearchIndexInfo[] { return getSearchIndexesImpl(this as any as TMongoSearchHost) }
  override isVectorSearchable(): boolean { return isVectorSearchableImpl(this as any as TMongoSearchHost) }
  override async search(text: string, query: DbQuery, indexName?: string) { return searchImpl(this as any as TMongoSearchHost, text, query, indexName) }
  override async searchWithCount(text: string, query: DbQuery, indexName?: string) { return searchWithCountImpl(this as any as TMongoSearchHost, text, query, indexName) }
  override async vectorSearch(vector: number[], query: DbQuery, indexName?: string) { return vectorSearchImpl(this as any as TMongoSearchHost, vector, query, indexName) }
  override async vectorSearchWithCount(vector: number[], query: DbQuery, indexName?: string) { return vectorSearchWithCountImpl(this as any as TMongoSearchHost, vector, query, indexName) }
  ...
  clearCollectionCache(): void { this._collection = undefined }

  async tableExists(): Promise<boolean> { return tableExistsImpl(this as any as TMongoSchemaSyncHost) }
  async ensureTable(): Promise<void> { return ensureTableImpl(this as any as TMongoSchemaSyncHost, this._table) }
  override async syncIndexes(): Promise<void> { return syncIndexesImpl(this as any as TMongoSchemaSyncHost) }
  async syncColumns(diff: TColumnDiff): Promise<TSyncColumnResult> { return syncColumnsImpl(this as any as TMongoSchemaSyncHost, diff) }
  async dropColumns(columns: string[]): Promise<void> { return dropColumnsImpl(this as any as TMongoSchemaSyncHost, columns) }
  async renameTable(oldName: string): Promise<void> { return renameTableImpl(this as any as TMongoSchemaSyncHost, oldName) }
  async recreateTable(): Promise<void> { return recreateTableImpl(this as any as TMongoSchemaSyncHost) }
  async dropTable(): Promise<void> { return dropTableImpl(this as any as TMongoSchemaSyncHost) }
  async dropViewByName(viewName: string): Promise<void> { return dropViewByNameImpl(this as any as TMongoSchemaSyncHost, viewName) }
  async dropTableByName(tableName: string): Promise<void> { return dropTableByNameImpl(this as any as TMongoSchemaSyncHost, tableName) }
  override getDesiredTableOptions(): TExistingTableOption[] { return getDesiredTableOptionsImpl(this._cappedOptions) }
  override async getExistingTableOptions(): Promise<TExistingTableOption[]> { return getExistingTableOptionsImpl(this as any as TMongoSchemaSyncHost) }
  override destructiveOptionKeys(): ReadonlySet<string> { return DESTRUCTIVE_OPTION_KEYS }
