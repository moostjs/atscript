...
function fk(fields: string[], targetTable: string, targetFields: string[], onDelete?: string, onUpdate?: string): TDbForeignKey {
  return { fields, targetTable, targetFields, onDelete: onDelete as TDbForeignKey['onDelete'], onUpdate: onUpdate as TDbForeignKey['onUpdate'] }
}

function snap(fields: string[], targetTable: string, targetFields: string[], onDelete?: string, onUpdate?: string): TForeignKeySnapshot {
