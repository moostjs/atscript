...
describe('computeTableOptionDiff', () => {
  ...
  it('should detect multiple changes', () => {
    const desired = [opt('engine', 'MyISAM'), opt('charset', 'latin1'), opt('collation', 'latin1_swedish_ci')]
    const existing = [opt('engine', 'InnoDB'), opt('charset', 'utf8mb4'), opt('collation', 'utf8mb4_unicode_ci')]
    const diff = computeTableOptionDiff(desired, existing)
