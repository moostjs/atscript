...
| Build integration | [unplugin.md](references/unplugin.md)                     | Vite/Rollup/Rolldown/Webpack/esbuild/Rspack/Farm, HMR, strict, `root` (config discovered from the wrong cwd, `pnpm -C`, unknown `@db.*`/`@ui.*` annotations), `optimizeDeps` prebundling of `@atscript/typescript/utils` ("optimized dependencies changed. reloading"), dts bundling of `.as` re-exports (tsdown/rolldown-plugin-dts) |
