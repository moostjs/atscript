    ...
    <div class="roadmap-visual">
        ...
        <section class="rv-section">
            <div class="rv-heading">
                ...
                <p class="rv-copy">One <code>.as</code> model feeds every output — types, validation, database adapters, HTTP layer, and IDE tooling today, with UI generation and more languages planned.</p>
            </div>
            ...
            <div class="rv-hub">
                ...
                <div class="rv-hub-arrow">
                    <svg width="2" height="24" viewBox="0 0 2 24"><line x1="1" y1="0" x2="1" y2="24" stroke="currentColor" stroke-width="2" stroke-dasharray="4 3"/></svg>
                    <svg width="14" height="10" viewBox="0 0 14 10"><path d="M1 1l6 8 6-8" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
                <div class="rv-hub-spokes">
                    ...
                    >
                        <span class="rv-spoke-icon" :style="getIconStyle(spoke.icon)" v-html="getIcon(spoke.icon).svg" />
