...
.planned-input.wide { width: 100%; }
.planned-input.short { width: 62%; }
.planned-input.tall { width: 100%; height: 54px; }
...
.cell-fill.short { width: 70%; }
.cell-fill.med { width: 85%; }
.cell-fill.long { width: 100%; }
</style>
