    ...
    <template #home-hero-before>
      ...
      <div class="custom-hero">
        <div class="hero-inner">
          <div class="hero-main">
            <p v-if="frontmatter.hero2.kicker" class="hero-kicker">
              {{ frontmatter.hero2.kicker }}
            </p>
        ...
        <div class="section-inner">
          ...
          <div class="comparison-grid animate-in">
            <div class="comparison-col">
              <div class="code-label muted-label">
                Before <span class="file-count">3 files</span>
              </div>
          ...
          <div class="aspect-grid">
            <div class="aspect-copy animate-in">
              ...
              <p class="aspect-desc">
                ...
                types, runtime metadata, and validation rules without a second schema layer.
              </p>
              ...
              <div class="aspect-links">
                <a href="/packages/typescript/quick-start" class="aspect-link"
                  >Learn more about TypeScript support</a
                >
                <a href="/packages/typescript/validation" class="aspect-link"
                  >See validation details</a
                >
              </div>
            </div>
          ...
          <div class="aspect-grid aspect-grid-reverse">
            <div class="aspect-copy animate-in">
              ...
              <p class="aspect-desc">
                ...
                REST/CRUD integrations instead of splitting those concerns into separate
                definitions. SQLite, PostgreSQL, MySQL, and MongoDB adapters are available today.
              </p>
              <div class="aspect-tags">
              ...
              <ul class="aspect-list">
                ...
                <li>
                  Use SQLite, PostgreSQL, MySQL, MongoDB, and Moost-based integrations from one
                  source of truth.
                </li>
              </ul>
              <div class="aspect-links">
                <a href="https://db.atscript.dev/guide/quick-start" class="aspect-link"
                  >Explore DB integrations</a
                >
                <a href="https://db.atscript.dev/http/crud" class="aspect-link"
                  >See REST/CRUD docs</a
                >
              </div>
            </div>
      ...
      <section class="section-architecture bg-diagonal">
        <div class="section-inner">
          <div class="architecture-block animate-in">
            ...
            <p class="aspect-desc">
              Atscript is not built as a TypeScript-only schema DSL. The core model and plugin
              system are meant to support other language targets over time, while TypeScript remains
              the first and most complete implementation today.
            </p>
            <div class="architecture-diagram">
              <span class="architecture-node">.as model</span>
              <span class="architecture-arrow">-></span>
              <span class="architecture-node architecture-node-active"
                >TypeScript plugin today</span
              >
              <span class="architecture-arrow">-></span>
...
@media (min-width: 900px) {
  ...
  .aspect-grid-reverse > :first-child {
    order: 2;
  }
  .aspect-grid-reverse > :last-child {
    order: 1;
  }
}
.aspect-copy {
...
:global(.dark) .architecture-node-active {
  background: rgba(174, 153, 252, 0.12);
}
.architecture-arrow {
...
.brand-block {
  box-shadow:
    0 0 40px rgba(71, 26, 236, 0.15),
    0 0 80px rgba(71, 26, 236, 0.08);
  border-color: rgba(71, 26, 236, 0.25);
}
:global(.dark) .brand-block {
  box-shadow:
    0 0 40px rgba(174, 153, 252, 0.2),
    0 0 80px rgba(174, 153, 252, 0.1);
