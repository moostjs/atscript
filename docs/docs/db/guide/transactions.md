...
For example, inserting a user with related tasks and project references runs as a single atomic operation internally — if any part fails, all changes roll back. See [Relations — Deep Operations](/db/relations/deep-operations) for details.
...
- [Relations — Deep Operations](/db/relations/deep-operations) — Auto-transactional nested CRUD
- [Schema Sync](/db/sync/) — Automatic schema migrations
- [Adapters](/db/adapters/) — Full adapter configuration and features
