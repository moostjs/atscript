...
External views:
- Are **not** created, modified, or dropped by [schema sync](/db/sync/)
...
For full details on the sync process, see [Schema Sync](/db/sync/).
...
- [Schema Sync](/db/sync/) — how sync manages the full lifecycle of views and tables
