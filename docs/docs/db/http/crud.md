...
See [Update & Patch](/db/api/update-patch) for details on patch semantics and embedded object updates.
...
- [CRUD Operations](/db/api/crud) — Programmatic `AtscriptDbTable` API (non-HTTP)
